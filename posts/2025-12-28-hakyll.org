...
tags: Programming, Haskell, Web, HTML, CSS&SCSS
toc: true
---
#+TITLE:Creating my first blog with Hakyll and Org!
...
After all this, I added the [[https://ogp.me/][Open Graph Protocol]] to my pages to make them nice to share. I also added the canonical url of the page with a quick ~$root$$url$~. One other minor fix is to limit the number of recent posts in ~index.html~ to 5.
