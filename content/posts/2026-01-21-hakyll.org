...
tags: Web, Haskell, HTML, SCSS, CSS, Nix, Emacs
toc: true
---
#+TITLE:Creating my first blog with Hakyll and Org!
...
Then I imported it into my ~default.scss~. I will expand on my SCSS configuration later in this post. But for now I have left it untouched. Note: the supported languages for syntax highlighting are given in [[https://github.com/jgm/skylighting][skylighting]] under `skylighting-core/xml`.
